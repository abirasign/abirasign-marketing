...
@section('title', 'Access Denied — AbiraSign')
...
">
    <div style="text-align: center; max-width: 480px; width: 100%;">
        <div style="font-size: 80px; font-weight: 700; color: #E0F2FE; line-height: 1; margin-bottom: 0.5rem; letter-spacing: -3px;">
            <span style="color: var(--teal);">4</span>03
        </div>
        <div style="font-size: 22px; font-weight: 700; color: var(--text-primary); margin-bottom: 0.5rem;">Access denied</div>
