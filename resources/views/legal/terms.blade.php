...
@section('title', 'Terms of Service — AbiraSign')
@section('meta_description', 'AbiraSign Terms of Service — the terms governing your use of the platform.')
    ...
    <div class="wrap">
        ...
        @if($policy)
            ...
            <p style="margin-top:8px;">
                <a href="/terms/archive" style="font-size:13px;color:var(--teal);">View all versions →</a>
            </p>
        @else
            ...
            @else
                ...
                @if(!$isCurrentVersion)
                    <div class="version-notice">
                        ...
                        <p>You are viewing an archived version (v{{ $policy->version }}) of these Terms of Service. <a href="/terms">View the current version →</a></p>
                    </div>
                @endif
